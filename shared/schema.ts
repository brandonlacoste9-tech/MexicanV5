...
export const users = pgTable("user_profiles", {
  ...
  tiGuyCommentsEnabled: boolean("guey_comments_enabled").default(true),
  hiveId: text("hive_id").default("mexico"),
  ...
  legendaryBadges: jsonb("legendary_badges").default([]), // NFT pointers / Mexico Heritage
  taxId: varchar("tax_id", { length: 50 }), // Pour la conformité fiscale (Loi 25)
  beeAlias: varchar("bee_alias", { length: 50 }), // Anonymous alias (e.g., Güey77)
  // Gamification Fields
  nectarPoints: integer("nectar_points").default(0),
  currentStreak: integer("current_streak").default(0),
  maxStreak: integer("max_streak").default(0),
  lastDailyBonus: timestamp("last_daily_bonus"),
  unlockedHives: jsonb("unlocked_hives").default(["mexico"]),
...
export const posts = pgTable(
  "publications",
  {
    ...
    aiDescription: text("ai_description"), // Güey's summary
    ...
    mexicoScore: integer("mexico_score").default(0), // Güey's cultural analysis signal
    ...
    hiveId: hiveEnum("hive_id").default("mexico"), // Content is siloed by hive
...
export const colonyTasks = pgTable(
  "colony_tasks",
  {
    ...
    origin: text("origin").default("Güey Swarm"),
...
export const transactions = pgTable(
  "transactions",
  {
    ...
    metadata: jsonb("metadata").default({}), // e.g., { message: "Pour ta poutine!", location: "CDMX" }
    hiveId: hiveEnum("hive_id").default("mexico"),
    createdAt: timestamp("created_at").defaultNow().notNull(),
  },
  (table) => ({
