...
export const Achievements: React.FC = () => {
  ...
  const [sortBy, setSortBy] = useState<"rarity" | "points" | "earned">(
    "earned",
  );
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  earned
                    ? "bg-gradient-to-br from-gold-900/10 to-yellow-900/10"
                ...
                <div className="flex items-start gap-4">
                  <div
                    className={cn(
                      ...
                      earned
                        ? "bg-gradient-to-br from-gold-500 to-yellow-600"
                        : "bg-white/5",
                    )}
                  >
        ...
        {filteredAchievements.length === 0 && (
          <div className="card-edge p-12 text-center">
            <p className="text-white/60 text-lg">
              Aucun accomplissement dans cette catégorie
            </p>
          </div>
        )}
      </div>
