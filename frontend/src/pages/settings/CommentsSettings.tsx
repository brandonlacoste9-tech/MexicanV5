...
export const CommentsSettings: React.FC = () => {
  ...
  const handleToggle = async (
    path:
      ...
      | "comments.filterOffensive"
      | "comments.autoHide"
      | "comments.allowGifs"
      | "comments.tiGuyCommentsEnabled",
    value: boolean,
  ) => {
    tap();
          ...
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-leather-300 text-sm">
                Permettre aux autres de commenter tes posts
              </p>
            </div>
            <button
              onClick={() =>
          ...
          <>
            <div className="leather-card rounded-xl p-4 stitched">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <h3 className="text-white font-semibold mb-1">
                    Filtrer les commentaires offensants
                  </h3>
                  <p className="text-leather-300 text-sm">
                    Masquer automatiquement les commentaires inappropriés
                  </p>
                </div>
                <button
                  onClick={() =>
                    handleToggle(
                      "comments.filterOffensive",
                      !preferences.comments.filterOffensive,
                    )
                  }
                  className={`relative w-14 h-8 rounded-full transition-colors ${
                    preferences.comments.filterOffensive
            ...
            <div className="leather-card rounded-xl p-4 stitched">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-leather-300 text-sm">
                    Masquer les commentaires avec plusieurs signalements
                  </p>
                </div>
                <button
                  onClick={() =>
            ...
            <div className="leather-card rounded-xl p-4 stitched">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-leather-300 text-sm">
                    Permettre les GIFs dans les commentaires
                  </p>
                </div>
                <button
                  onClick={() =>
                    handleToggle(
                      "comments.allowGifs",
                      !preferences.comments.allowGifs,
                    )
                  }
                  className={`relative w-14 h-8 rounded-full transition-colors ${
                    preferences.comments.allowGifs
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={() =>
                    handleToggle(
                      "comments.tiGuyCommentsEnabled",
                      !preferences.comments.tiGuyCommentsEnabled,
                    )
                  }
                  className={`relative w-14 h-8 rounded-full transition-all duration-300 ${
                    preferences.comments.tiGuyCommentsEnabled
                      ? "bg-gold-500 shadow-[0_0_10px_rgba(212,175,55,0.4)]"
                      : "bg-leather-700"
                  }`}
                >
                  <div
