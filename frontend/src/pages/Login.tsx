...
export const Login: React.FC = () => {
  ...
  const handleSubmit = React.useCallback(
    async (e: React.FormEvent) => {
      ...
      try {
        ...
        if (!isEmail) {
          if (debugMode)
            console.log("👤 [LOGIN] Detected username, resolving to email...");
          try {
            ...
            if (debugMode)
              console.log("✅ [LOGIN] Resolved email:", data.email);
            targetEmail = data.email;
          } catch (resolveErr: any) {
            throw new Error(resolveErr.message, { cause: resolveErr });
          }
        }
        ...
        if (error) {
          ...
          if (msg.includes("Invalid login credentials"))
            msg = "Mot de passe ou courriel incorrect";
          if (msg.includes("Email not confirmed"))
            msg = "Courriel non confirmé. Vérifie tes courriels.";
  ...
  React.useEffect(() => {
    if (debugMode)
      console.log("📲 [LOGIN PAGE] Rendered", { isLoading, error });
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, #0a0a0a 0%, #1a1510 50%, #0d0b09 100%)",
      }}
    >
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-10 overflow-visible">
            ...
            >
              <div
                ...
                style={{
                  ...
                  boxShadow: "inset 0 0 10px rgba(255,191,0,0.05)",
                }}
              />
          ...
          <p
            className="text-sm font-bold tracking-[0.3em] mt-2 uppercase"
        ...
        <div
          ...
          style={{
            ...
            boxShadow: `0 20px 40px rgba(0,0,0,0.6), inset 0 1px 0 rgba(255,255,255,0.08), inset 0 -1px 0 rgba(0,0,0,0.5)`,
          }}
        >
          {/* Gold Stitching */}
          <div
            ...
            style={{
              ...
              boxShadow: "inset 0 0 4px rgba(255, 215, 0, 0.1)",
            }}
          />

          <h2
            className="text-2xl font-bold mb-6 slide-up"
            style={{ color: "#E8DCC4" }}
          >
            {copy.auth.login}
          </h2>
          ...
          {error && (
            ...
            >
              ...
              {debugMode && (
                <p className="text-red-300 text-xs mt-2">Debug: {error}</p>
              )}
            </div>
          )}
            ...
            <button
              ...
              style={{
                background: isLoading
                  ? "#DAA520"
                  : "linear-gradient(135deg, #FFD700 0%, #FFC125 50%, #DAA520 100%)",
                color: "#1a1a1a",
                boxShadow:
                  "0 4px 20px rgba(255,191,0,0.4), inset 0 1px 0 rgba(255,255,255,0.3)",
              }}
            >
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center">
              <span
                ...
                style={{ background: "#13120f", color: "#8B7355" }}
              >
                Ou
              </span>
            </div>
        ...
        <p className="text-center text-sm mt-8" style={{ color: "#8B7355" }}>
          ...
          <Link
            to="/signup"
            className="font-bold transition-colors link-underline"
            style={{ color: "#DAA520" }}
          >
