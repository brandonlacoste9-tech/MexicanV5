...
if (allCriticalValid) {
  ...
  console.log(
    "   2. Use Railway Postgres (ojea-db) for DATABASE_URL if available",
  );
  ...
  console.log(
    "   6. Test: https://ojeav5-production.up.railway.app/api/health",
  );
} else {
  ...
  console.log(
    "   2. Use Railway Postgres connection string (ojea-db) for DATABASE_URL",
  );
