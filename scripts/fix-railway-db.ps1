...
railway variables --service "ojea-backend" | findstr "DATABASE_URL PGHOST PGUSER"
...
Write-Host "2. Select your 'ojea-backend' service" -ForegroundColor White
...
Write-Host "   railway variables --service 'ojea-backend' --set 'DATABASE_URL=your_url_here'" -ForegroundColor Yellow
Write-Host ""
