#!/usr/bin/env tsx
/**
 * Index Ojea codebase and Antigravity skills to Vertex AI Search Data Store
 *
...
const BUCKET_NAME =
  process.env.GCS_KNOWLEDGE_BUCKET || "ojea-knowledge-ingestion";
...
async function main() {
  console.log("🔍 Indexing Ojea codebase for Vertex AI Search...\n");
