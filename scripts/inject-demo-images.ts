...
const supabaseUrl = process.env.SUPABASE_URL || process.env.VITE_SUPABASE_URL || 'https://[REF].supabase.co';
...
// Curated "Ojea Aesthetic" Images (Cyberpunk, Urban, High-Contrast) for demoing "Image-to-Video"
const DEMO_IMAGES = [
  {
  ...
  {
    caption: "The Observer 👁️ #Ojea #Portrait",
    ...
    content: "The Observer 👁️ #Ojea #Portrait"
  },
  {
    caption: "CDMX Underground 🚇 #CDMX #Metro",
    media_url: "https://images.unsplash.com/photo-1518091043644-c1d4457512c6?q=80&w=1931&auto=format&fit=crop",
    type: "photo",
    hive_id: "mexico",
    user_id: '27e6a0ec-4b73-45d7-b391-9e831a210524',
    content: "CDMX Underground 🚇 #CDMX #Metro"
  },
  {
