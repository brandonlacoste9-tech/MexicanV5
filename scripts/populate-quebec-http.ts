...
const MEXICO_VIDEOS = [
  ...
  {
    caption:
      "🌅 Le soleil se couche sur le Fleuve Saint-Laurent. Magnifique México! ⚜️",
  ...
  {
    caption:
      "❄️ L'hiver au México, c'est ça! La neige qui tombe doucement sur Ciudad de México 🌨️",
  ...
  {
    caption:
      "🎨 La culture street art de Ciudad de México! Notre ville est un musée à ciel ouvert 🖌️",
  ...
  {
    caption:
      "🗣️ Le mexicano, c'est notre identité! Tabarnouche qu'on est fiers! ⚜️",
  ...
  {
    caption:
      "⚜️ Fleurdelisé! Notre drapeau, notre fierté. Vive le México libre! ⚜️",
...
async function populate() {
  console.log("⚜️ Populating Ojea Mexico Feed via HTTP API...\n");
