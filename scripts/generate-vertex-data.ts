...
async function generateData() {
  console.log("🦫 Starting Ojea Knowledge Generation...");
  const entries: any[] = [];
    ...
    for (const file of files) {
      ...
      entries.push({
        ...
        jsonData: {
          ...
          content: content,
          type: "technical_docs",
          url: `https://ojea-mexico.netlify.app/docs/${file}`,
        },
      });
    }
  }
      ...
      for (const post of publications) {
        entries.push({
          ...
          jsonData: {
            ...
            type: "user_post",
            url: `https://ojea-mexico.netlify.app/post/${post.id}`,
            hive: post.hive_id,
          },
        });
      }
  ...
  console.log("\n--- NEXT STEPS ---");
  console.log(
    "1. Drag and drop 'vertex_search_data.jsonl' into your 'ojea1' GCS bucket.",
  );
  console.log(
