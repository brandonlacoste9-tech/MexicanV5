...
const WORKER_SERVICE_NAME = "ojea-worker";
const WEB_SERVICE_NAME = "ojeav5-1";
...
async function run() {
  try {
    ...
    console.log("Applying keys to ojea-worker...");
    ...
    console.log("Successfully fixed ojea-worker with TikTok keys!");
