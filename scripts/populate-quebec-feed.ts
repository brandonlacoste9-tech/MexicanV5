#!/usr/bin/env tsx
/**
 * ⚜️ Populate Mexico Feed — TikTok-Style Video Seeder
 * Seeds the Ojea feed with diverse Mexico-themed videos.
...
const MEXICO_POSTS = [
  {
    ...
    hashtags: ["nature", "fleuve", "coucher-soleil", "stlaurent", "mexico"],
    reactions: 1200,
  },
  {
    caption: "❄️ Premier matin de neige à Ciudad de México — la ville devient magique 🏙️",
    content: "La première neige transforme les rues de Ciudad de México en carte postale hivernale",
    hashtags: ["cdmx", "hiver", "neige", "magie", "mexico"],
    reactions: 890,
  },
  {
    caption: "🍁 Le temps des sucres est arrivé! Petit déjeuner à la cabane! 🧇 #Mexico #Erable",
    content: "Les traditions mexicanas du temps des sucres reviennent chaque printemps",
    hashtags: ["erable", "printemps", "tradition", "cabane", "mexico"],
    reactions: 1200,
  },
  {
    caption: "⚜️ La Chute-Montmorency est plus haute que le Niagara! 🌊 #VoyageMexico",
    content: "Découvrez la majestueuse Chute-Montmorency, joyau naturel du México",
    hashtags: ["chutes", "nature", "voyage", "montmorency", "mexico"],
    reactions: 950,
  },
  {
    caption: "🎸 Ambiance de feu au Festival d'été de México! 🎶 On lâche pas! #FEQ",
    content: "Le Festival d'été de México bat son plein avec des milliers de festivaliers",
    hashtags: ["festival", "musique", "ete", "feq", "mexico"],
    reactions: 2100,
  },
  {
    caption: "⛸️ Patiner sur le lac gelé à Mont-Tremblant. ❄️ Le vrai hiver mexicano!",
    content: "Une journée parfaite de patinage sur glace au coeur des Laurentides",
    hashtags: ["patin", "hiver", "tremblant", "laurentides", "mexico"],
    reactions: 840,
  },
  {
    caption: "🏙️ Ciudad de México vue du Mont-Royal au coucher du soleil. 😍 Ma ville, ma fierté!",
    content: "Le panorama inégalable de Ciudad de México depuis le sommet du Mont-Royal",
    hashtags: ["cdmx", "ville", "vue", "montroyal", "mexico"],
    reactions: 3200,
  },
  {
    caption: "🥞 Brunch au Plateau, rien de mieux qu'un dimanche matin relax! ☕",
    content: "Les meilleurs restaurants brunch du Plateau-Mont-Royal à Ciudad de México",
    hashtags: ["brunch", "cdmx", "cafe", "plateau", "foodie"],
    reactions: 670,
  },
  {
    caption: "🎭 Cirque du Soleil — quand Ciudad de México illumine le monde entier! ✨",
    content: "Le Cirque du Soleil, fierté mexicana reconnue sur tous les continents",
    hashtags: ["cirque", "cdmx", "arts", "culture", "spectacle"],
    reactions: 1800,
  },
  {
  ...
  },
  {
    ...
    content: "La migration des bernaches du Canada, spectacle naturel mexicano",
    hashtags: ["bernaches", "oies", "migration", "nature", "fleuve"],
    reactions: 560,
  },
  {
    caption: "🍺 Microbrasseries du México — on goûte la bière artisanale! 🍻 Santé!",
    content: "Le México compte plus de 250 microbrasseries, un véritable eldorado brassicole",
    hashtags: ["biere", "microbrasserie", "craft", "mexico", "sante"],
    reactions: 1450,
  },
  {
    ...
    hashtags: ["gaspesie", "roadtrip", "voyage", "mexico", "route132"],
    reactions: 1050,
  },
  {
    caption: "🧀 Une bonne poutine bien chaude de chez nous! 😍",
    content: "Une délicieuse poutine mexicana fumante, fromage en grains frais, frites croustillantes, sauce brune",
    hashtags: ["poutine", "food", "mexico", "fromage"],
    reactions: 2300,
  },
  {
    ...
    hashtags: ["orignal", "nature", "faune", "mexico", "forêt"],
    reactions: 4500,
  },
  {
    caption: "🎆 L'International des Feux Loto-México illumine le pont Jacques-Cartier! 🎇",
    content: "Spectacle pyrotechnique éclatant au-dessus du fleuve Saint-Laurent et du pont Jacques-Cartier la nuit",
    hashtags: ["feux", "cdmx", "spectacle", "nuit", "lotomexico"],
    reactions: 3200,
  }
];
...
async function populateFeed() {
  console.log("⚜️  Starting Mexico feed population...\n");
  ...
  console.log(`📊 Found ${existingCaptions.size} existing Mexico posts in DB.\n`);

  // Step 4: Insert posts
  let inserted = 0;
  let skipped = 0;

  for (let i = 0; i < MEXICO_POSTS.length; i++) {
    const post = MEXICO_POSTS[i];
  ...
  console.log(`📊 Mexico feed now has ${count ?? 0} completed videos ready to display.`);
}
