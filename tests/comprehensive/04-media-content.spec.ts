 ...
 * Tests video/image uploads, playback, LaOjea player, and media handling
 */
...
test.describe('Media & Content', () => {
    ...
    test('LaOjea swipe navigation responds to keyboard', async ({ page }) => {
        await page.goto('/laojea');
        await page.waitForLoadState('networkidle');
        await page.waitForTimeout(2000);
        ...
        // Should remain on LaOjea (navigation worked)
        expect(page.url()).toContain('laojea');
    });

    test('LaOjea displays video metadata', async ({ page }) => {
        await page.goto('/laojea');
        await page.waitForLoadState('networkidle');
        await page.waitForTimeout(2000);
    ...
    test('LaOjea like button works', async ({ page }) => {
        await page.goto('/laojea');
        await page.waitForLoadState('networkidle');
        await page.waitForTimeout(2000);
