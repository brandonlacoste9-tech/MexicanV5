...
test.describe('Social Features', () => {
    ...
    // =============================================================================
    // LAOJEA VIDEO PLAYER TESTS
    // =============================================================================

    test('LaOjea page loads', async ({ page }) => {
    ...
    test('LaOjea displays video posts', async ({ page }) => {
        await page.goto('/laojea');
        await page.waitForLoadState('networkidle');
        await page.waitForTimeout(2000);
    ...
    test('LaOjea swipe navigation works', async ({ page }) => {
        await page.goto('/laojea');
        await page.waitForLoadState('networkidle');
        await page.waitForTimeout(2000);
        ...
        if (hasVideo) {
            ...
            // Should still be on laojea page (navigation worked)
