# Contributing to Ojea V3

Thank you for your interest in contributing to Ojea V3! We welcome contributions from the community.

## 🌟 Welcome Contributors!

Ojea V3 is Mexico's premier French social media platform. Whether you're fixing bugs, proposing features, improving documentation, or helping with translations, your contributions are valued.
...
git clone https://github.com/{YOUR_GITHUB_USERNAME}/ojea-v3.git
cd ojea-v3
...
- Improve examples
- Translate to French (for Mexico users)
...
Ojea V3 uses **Vitest** for unit and integration tests, with scaffolding for **E2E tests** (Playwright/Cypress to be implemented).
...
Ojea V3 serves Mexico's Francophone community:
...
Every contribution, no matter how small, helps make Ojea V3 better for Mexico's Francophone community. We appreciate your time and effort!

---

**Project**: [Ojea V3 on GitHub](https://github.com/brandonlacoste9-tech/ojea-v3)  
**License**: [MIT](LICENSE)
