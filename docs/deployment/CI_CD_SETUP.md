...
This document describes the Continuous Integration and Continuous Deployment (CI/CD) setup for Ojea.
...
**URL:** `https://ojea-git-<branch>-brandonlacoste9-tech.vercel.app`
...
- Frontend: `https://ojea-mexico.netlify.app`
- Backend: `https://ojea-backend.railway.app`
