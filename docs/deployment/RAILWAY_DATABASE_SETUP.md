...
4. ✅ 15 Mexico seed posts (if none exist)
...
- ✅ Automatically insert 15 Mexico posts if none exist
...
- 15 Mexico-themed posts
- Only inserted if no Mexico posts exist
...
1. **Railway Logs:**
   ...
   - "📊 Status: X user(s), Y Mexico post(s)"

2. **API Endpoint:**

   ```bash
   curl https://ojea-api.railway.app/api/feed
   ```
...
3. **Visit ojea-mexico.netlify.app/feed** to see the 15 Mexico posts
4. **Celebrate!** 🦫⚜️🇨🇦
