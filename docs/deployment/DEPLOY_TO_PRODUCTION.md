...
This guide details the environment variables and build steps required to deploy Ojea V3 after the removal of the legacy Express Session infrastructure.
...
- Run SQL: `SELECT raw_user_meta_data FROM auth.users WHERE email = 'ojeamexico@gmail.com';`
