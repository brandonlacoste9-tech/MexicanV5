# Ojea Credits "War Chest" Summary
...
| **Dialogflow CX**     | **$813.16**   | Voice commands, audio sessions, Mexicano NLU   | `docs/DIALOGFLOW_CX_VOICE_SETUP.md`         |
...
2. **Grounded Generation:** Generate responses based on your Ojea data
3. **Agent Memory:** Max and Güey query your private knowledge base
...
1. **Voice Navigation:** "Ojea, montre-moi le feed"
2. **Mexicano Support:** Understand Mexico French slang
3. **Multi-Channel:** WhatsApp (Max), in-app, phone lines

**Setup:**

1. Create Dialogflow CX agent (French Canada)
2. Create intents for Ojea commands
...
✅ **Dialogflow CX:** Agent created, voice commands working, Mexicano support enabled  
