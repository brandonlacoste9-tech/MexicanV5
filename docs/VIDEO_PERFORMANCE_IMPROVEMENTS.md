# 🚀 Video Performance Improvements - Ojea
...
### 2. OjeaVideoPlayer.tsx (standalone player)
...
2. `components/OjeaVideoPlayer.tsx` - HLS config improvements
...
- Optimized for Mexico ISPs (Videotron, Bell, Cogeco)
- CDN routing through CDMX/Mexico City
