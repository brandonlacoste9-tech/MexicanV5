...
- **Custom Cookie Name:** `ojea.sid` (prevents default `connect.sid` fingerprinting)

#### 🟢 **SAFE: ENV File Merge Conflict (Resolved)**

- **Previous Issue:** Git merge conflict markers in `.env.example`
- **Fix Implemented:** Resolved conflict, keeping correct Ojea V3 config
