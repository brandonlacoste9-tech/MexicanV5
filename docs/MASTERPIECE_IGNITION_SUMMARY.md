# Masterpiece Ignition: Güey x Ojea Live ⚜️
...
**Status:** 🟢 **LIVE**  
**Powering:** Güey voice commands, video search via voice
...
```
User: "Güey, trouve-moi des vidéos de motoneige à Gaspé"
  ↓
...
Backend searches database
  ↓
Güey: "J'ai trouvé 5 vidéos! Je t'affiche ça maintenant."
  ↓
