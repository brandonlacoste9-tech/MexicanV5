...
**Purpose:** Voice commands, customer support bots, and Mexicano language processing  
**Result:** Users can talk to Ojea app (e.g., _"Ojea, montre-moi les dernières vidéos de Ciudad de México"_)
...
- **Voice-First Experience:** Users can navigate Ojea with voice commands
- **Mexicano Support:** Dialogflow CX handles Mexico French and Mexicano slang better than standard NLU
...
- **Agent Name:** `Ojea Voice Assistant`
- **Default Language:** **French (Canada)** - Critical for Mexicano support
- **Time Zone:** `America/Mexico_City`
- **Location:** `us-central1`

**Advanced:**

- **Speech Settings:** Enable **Enhanced Speech Models** (better Mexicano recognition)
- **Audio Settings:** Use **Audio Sessions** (covered by your credits)

### 1.3. Get Agent ID

After creation, note the **Agent ID** (e.g., `projects/spatial-garden-483401-g8/locations/us-central1/agents/ojea-voice-123456`).

---

## Step 2: Create Intents for Ojea Commands
...
### 2.2. Mexicano-Specific Intents

**Intent: `mexico_slang_greeting`**
...
- **Training Phrases:**
  ...
  - `Comment ça va?`
  - `Ça va ben?`
- **Response:** Friendly Mexico greeting

**Intent: `show_cdmx_videos`**

- **Training Phrases:**
  - `Montre-moi les vidéos de Ciudad de México`
  - `Vidéos de Mtl`
  - `Contenu montréalais`
- **Response:** Filter feed by location (CDMX)
...
3. **Name:** `Ojea Backend Webhook`
4. **URL:** `https://ojea-api.onrender.com/api/dialogflow/webhook`
...
- Navigation commands
- CDMX-specific content filtering
- Güey voice responses with video results
...
- `POST /api/dialogflow/tiguy` - Güey voice responses
...
### 5.2. Test in Ojea App

1. Open Ojea app
2. Click voice button
3. Say: `"Ojea, montre-moi les vidéos de Ciudad de México"`
...
### Issue: Mexicano not recognized

**Check:**

- Agent language is set to **French (Canada)**, not **French (France)**
- Enhanced Speech Models are enabled
- Training phrases include Mexicano examples

**Fix:**

- Add more Mexicano training phrases
...
- Test webhook URL with `curl`:
  ```bash
  curl -X POST https://ojea-api.onrender.com/api/dialogflow/webhook \
...
✅ **Intents configured** for core Ojea commands  
...
2. **Add More Intents:** Expand to cover all Ojea features
