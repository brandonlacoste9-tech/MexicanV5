# 💬 Ojea Messenger - Chat Interface

## 🎨 Design Theme

- **Leather & Gold Stitched** - Louis Vuitton x México aesthetic
- Deep brown leather background (#2b1f17)
- Gold accents (#d4af37) with stitching borders
- Águila pattern overlay
...
- **⚜️ Güey AI** - Mexico mexicano-speaking AI assistant

## 🎯 UI Elements

### Header

- Ojea logo with aguila
...
- User (purple) vs Güey (gold/amber) colors
- Typing indicators
...
- Text input with placeholder "Message Güey en mexicano..."
