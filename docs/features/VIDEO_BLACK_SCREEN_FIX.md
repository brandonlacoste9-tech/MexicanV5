# Ojea Video Black Screen - COMPLETE FIX GUIDE
...
```bash
cd /home/north/.openclaw/workspace/OjeaV5-fresh
...
3. Verify URL: `https://ojeav5-production.up.railway.app/api/webhooks/mux`
...
**Need help?** Run: `./skills/ojea-video-repair/repair-videos.sh`
