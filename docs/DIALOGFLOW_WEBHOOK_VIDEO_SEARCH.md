...
**Feature:** Güey can search videos via voice commands
...
1. **User speaks:** _"Güey, trouve-moi des vidéos de motoneige à Gaspé."_
...
4. **Backend:** Webhook handler searches Ojea database for matching videos
5. **Güey replies:** _"J'ai trouvé 5 vidéos pour 'motoneige à Gaspé'! Je t'affiche ça maintenant."_
...
- `location` - Optional location filter (e.g., "Gaspé", "Ciudad de México")
...
- _"Montre-moi les vidéos de Ciudad de México"_
- _"Vidéos de Mtl"_
- _"Contenu montréalais"_

**Webhook Response:**

- Filters posts by location containing "CDMX" or "Ciudad de México"
- Returns videos with CDMX-specific content
...
| **Audio Output**     | Audio Session | Included         | Güey replies                       |
...
✅ **Güey voice** replies with video count  
✅ **Frontend** displays video results from payload  
✅ **Dialogflow CX credits** showing usage in billing dashboard

---

**Güey can now search videos via voice commands using Dialogflow CX credits!** 🎤🎥
