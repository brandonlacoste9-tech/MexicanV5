# Railway + Docker (Ojea Backend)

Railway is configured to build and run the Ojea backend using the project’s **Dockerfile**.
...
3. Set the image to: `brandontech/ojea-backend:latest`
