...
**Purpose:** Index your entire Ojea codebase and Antigravity skills for RAG (Retrieval-Augmented Generation)  
**Result:** Max, Güey, and other agents query your private data store instead of hallucinating
...
- **No Hallucination:** Answers are grounded in your actual Ojea architecture and Antigravity patterns.
- **Mexico Market:** Index Mexicano patterns, Mexico cultural references, and Ojea-specific logic.
...
- **Name:** `ojea-knowledge-base`
- **Display Name:** `Ojea Knowledge Base`
...
- **Storage Bucket:** Create or select a GCS bucket (e.g., `ojea-knowledge-ingestion`)
...
After creation, note the **Data Store ID** (e.g., `ojea-knowledge-base-1234567890`). You'll need this for `VERTEX_DATA_STORE_ID`.
...
└── mexico-context/
    ├── MEXICO_STYLE_GUIDE.md
    └── mexicano-patterns.md
```
...
VERTEX_DATA_STORE_ID=ojea-knowledge-base-1234567890
...
Update Güey to query Data Store before generating responses:
...
When you ask Cursor about Ojea architecture, it can query your Data Store via Vertex AI Search API.
...
1. **Test RAG:** Ask Güey a Ojea-specific question (e.g., "How does the feed pagination work?")
