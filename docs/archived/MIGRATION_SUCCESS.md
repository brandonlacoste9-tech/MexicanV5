...
```bash
curl https://ojeav5-production.up.railway.app/api/feed
```

**Infinite Scroll Feed:**

```bash
curl "https://ojeav5-production.up.railway.app/api/feed/infinite?type=explore&limit=5"
```
...
- Railway Project: ojeaV5
- Database Service: ojea-db
- Backend URL: https://ojeav5-production.up.railway.app
