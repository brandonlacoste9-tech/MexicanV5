# 🤖 Copilot Agent Optimization Guide for Ojea V3
...
This guide explains how to effectively use GitHub Copilot agents on the Ojea V3 project. It includes templates, best practices, and the complete workflow for deploying AI agents to audit and fix your codebase.
...
```
https://github.com/brandonlacoste9-tech/ojea-v3/issues/new/choose
```
...
1. **Create Issues:**
   - Go to https://github.com/brandonlacoste9-tech/ojea-v3/issues/new/choose
...
**Made with ❤️ for Ojea - L'app sociale du México 🇨🇦⚜️**
