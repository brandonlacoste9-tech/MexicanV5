# 🐛 Ojea V3 Bug & Feature Tracker

Comprehensive tracking document for all bugs, features, and enhancements in the Ojea V3 project.
...
| ------------------------- | -------- | -------- | -------- | ------------------------------------------------- |
| Stripe.js not loading     | ✅ Fixed | Critical |          | Redundant script removed, using @stripe/stripe-js |
| Supabase 422 on signup    | ✅ Fixed | Critical |          | Auth timeout increased to 15s to prevent race     |
| React DOM insertion error | ✅ Fixed | High     |          | CSP fixed for Vercel Live and script tags cleaned |
| Manifest 401 error        | ✅ Fixed | Low      |          | Exclusion added in vercel.json rewrites           |
| API 400 Bad Request       | ✅ Fixed | Critical |          | Corrected project ref and French schema mapping   |
| API 500 Internal Error    | ✅ Fixed | Critical |          | Corrected project ref and fixed Stories query     |
| BottomNav Visibility      | ✅ Fixed | High     |          | Refactored MainLayout with fixed height frame     |
| Guest Mode Alerts         | ✅ Fixed | Medium   |          | Added local interaction guards for guests         |
...
| **Created**        | 2024-12-14                                                        |
| **Updated**        | 2024-12-15                                                        |
| **PR**             | brandonlacoste9-tech/ojea-v3#123                                |
| **ETA**            | 1h                                                                |
...
| **Created**        | 2024-12-14                                                             |
| **Updated**        | 2024-12-15                                                             |
| **PR**             | brandonlacoste9-tech/ojea-v3#124                                     |
| **ETA**            | 1h                                                                     |
...
- Poor experience for Mexico French-speaking users
...
| **Created**        | 2024-12-14                                                             |
| **Updated**        | 2024-12-15                                                             |
| **PR**             | brandonlacoste9-tech/ojea-v3#125                                     |
| **ETA**            | 1h                                                                     |
...
- [x] **API 400 Bad Request on /api/feed** (Caused by wrong project ref and column mismatch) - **FIXED**
- [x] **API 500 Internal Server Error on /api/stories** (Caused by wrong project ref) - **FIXED**
- [x] **BottomNav visibility issues** (Fixed via MainLayout redesign) - **FIXED**
- [x] **Guest Mode Participation Alerts** (Added to Feed actions) - **FIXED**
- [x] **Vercel lint warning (Value deprecated)** - **FIXED**
