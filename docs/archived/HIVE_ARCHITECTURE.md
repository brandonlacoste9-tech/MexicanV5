...
│  ─────────────  │ │  ─────────────  │ │  ─────────────  │
│  guey-chat    │ │  moderation     │ │  analytics      │
...
├── bees/
│   ├── guey-chat.ts        # Mexico mexicano chatbot
...
| ---------------------- | ------------------ | --------- | --------------- | ------- |
| `guey-chat`          | Güey Chat        | worker    | DeepSeek        | 🟢 LIVE |
...
Ojea communicates with Python bees (e.g., `finance-bee`, `health-bee`) via the `colony_tasks` database table.
