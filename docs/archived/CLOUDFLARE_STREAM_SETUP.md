...
Ojea now supports **Cloudflare Stream** as a video hosting provider alongside MUX. This provides:
...
const isCloudflareStream =
  url.includes("cloudflarestream.com") || url.includes("cloudflare-stream.com");
