...
- **Host Detection:**
  - If user visits `ojea-mexico.netlify.app` -> Load **MEXICO_CONFIG**.
...
- **Zero-Build Deploy:**
  ...
  - **Benefit:** Fix a bug in the Chat? It is fixed for Mexico, Brazil, and Mexico instantly.
