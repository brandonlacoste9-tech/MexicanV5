...
2. Select your **backend service** (not ojea-db)
...
MAX_API_URL=https://ojeav5-production.up.railway.app npm run wake:max
```
...
- Make sure you're in the backend service, not `ojea-db`
