...
`https://ojea-api.onrender.com/api/...`
...
```bash
curl -X POST "https://ojea-api.onrender.com/api/seed/providers?limit=15" \
...
```bash
curl -X POST "https://ojea-mexico.netlify.app/api/seed/providers?limit=15"
```
