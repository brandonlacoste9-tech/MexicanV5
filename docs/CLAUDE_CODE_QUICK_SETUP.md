# Claude Code Quick Setup for OjeaV5 🚀

**Goal:** Get Claude Code working with your OjeaV5 project
...
```
"List all tables in the Ojea database"
```
...
- Understand OjeaV5 architecture
