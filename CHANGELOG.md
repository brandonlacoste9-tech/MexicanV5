...
All notable changes to the Ojea V3 project will be documented in this file.
...
- Instructions for creating "Ojea V3 Bug & Feature Tracker" board
...
- French-language friendly (Mexico-focused platform)
...
- Virtual gift system
- Responsive design
- French-language interface for Mexico market
