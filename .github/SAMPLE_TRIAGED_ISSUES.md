...
```
Manual Testing:
1. Open https://ojea-mexico.netlify.app in incognito
...
**Description:**
When users create posts containing special characters (emojis, French accented characters like é, è, à, ç), Supabase API returns 422 Unprocessable Entity error. Critical issue for a French-language platform serving Mexico users.
...
- Primary market is Mexico (French)
