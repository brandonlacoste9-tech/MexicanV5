...
Quick reference for common tasks in the Ojea V3 bug and feature tracking system.
...
```bash
# Via Web
1. Go to: https://github.com/brandonlacoste9-tech/ojea-v3/issues/new/choose
2. Select "🐛 Bug Report"
3. Fill out the form
4. Submit
...
```bash
# Clone repo
git clone https://github.com/brandonlacoste9-tech/ojea-v3.git
cd ojea-v3
...
- [Create Issue](https://github.com/brandonlacoste9-tech/ojea-v3/issues/new/choose)
- [View All Issues](https://github.com/brandonlacoste9-tech/ojea-v3/issues)
- [Project Board](https://github.com/brandonlacoste9-tech/ojea-v3/projects)
- [Discussions](https://github.com/brandonlacoste9-tech/ojea-v3/discussions)
...
2. Search [closed issues](https://github.com/brandonlacoste9-tech/ojea-v3/issues?q=is%3Aissue+is%3Aclosed) for similar cases
3. Ask in [Discussions](https://github.com/brandonlacoste9-tech/ojea-v3/discussions)
...
- **Project Repository**: [ojea-v3](https://github.com/brandonlacoste9-tech/ojea-v3)
- **Issue Tracker**: [Issues](https://github.com/brandonlacoste9-tech/ojea-v3/issues)
- **Discussions**: [Discussions](https://github.com/brandonlacoste9-tech/ojea-v3/discussions)
...
- 📝 [Create New Issue](https://github.com/brandonlacoste9-tech/ojea-v3/issues/new/choose)
- 🐛 [View Bugs](https://github.com/brandonlacoste9-tech/ojea-v3/issues?q=is%3Aissue+is%3Aopen+label%3Abug)
- ✨ [View Features](https://github.com/brandonlacoste9-tech/ojea-v3/issues?q=is%3Aissue+is%3Aopen+label%3Afeature)
- 🔴 [Critical Issues](https://github.com/brandonlacoste9-tech/ojea-v3/issues?q=is%3Aissue+is%3Aopen+label%3Acritical)
- 📊 [Project Board](https://github.com/brandonlacoste9-tech/ojea-v3/projects)
...
_Made with ❤️ for Mexico | Fait avec ❤️ pour le México 🇨🇦⚜️_
