# Copilot Agent Instructions for Ojea V3 / Kryptotrac-xx

## 🏗️ Architecture & Major Components

- **Monorepo**: Contains Ojea (social/crypto app), Kryptotrac-xx (Next.js crypto tracker), and Colony OS (Python microservices).
...
- **Dev Server**: `npm run dev` (Ojea), `pnpm dev` (Kryptotrac-xx)
...
- **Testing**: E2E tests in `test/e2e/` (Ojea) and `Kryptotrac-xx/tests/`. Use Vitest + React Testing Library. Python: `pytest` in `infrastructure/colony/bees/tests/`.
