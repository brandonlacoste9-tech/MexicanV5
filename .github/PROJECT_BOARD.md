# GitHub Project Board Setup for Ojea V3

This document provides instructions for creating and configuring the "Ojea V3 Bug & Feature Tracker" GitHub Project Board.
...
**Project Name**: Ojea V3 Bug & Feature Tracker  
...
1. Navigate to repository: `https://github.com/brandonlacoste9-tech/ojea-v3`
2. Click on **"Projects"** tab
3. Click **"New project"** or **"Link a project"** > **"New project"**
4. Choose **"Board"** template
5. Enter project details:
   - **Name**: `Ojea V3 Bug & Feature Tracker`
   - **Description**: `Comprehensive tracking for bugs, features, and enhancements in the Ojea V3 social media platform`
...
gh project create --title "Ojea V3 Bug & Feature Tracker" \
...
gh issue list --label bug --json number --jq '.[].number' | \
  xargs -I {} gh project item-add {PROJECT_NUMBER} --owner brandonlacoste9-tech --repo ojea-v3 --issue {}
...
```bash
# Get repository ID
REPO_ID=$(gh api repos/brandonlacoste9-tech/ojea-v3 --jq '.id')
...
gh api graphql -f query='
  mutation {
    createProjectV2(input: {
      ownerId: "OWNER_ID"
      title: "Ojea V3 Bug & Feature Tracker"
...
**Maintained By**: Ojea V3 Development Team
